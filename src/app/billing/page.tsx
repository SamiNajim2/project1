...
export const metadata = { title: "Billing · Strategy Agent" };
      ...
      <main className="mx-auto max-w-2xl px-4 pt-12 pb-20 sm:px-6">
        ...
        <Card className="p-6 sm:p-8">
          <div className="flex flex-wrap items-start justify-between gap-3">
            ...
            {active ? (
              <Pill tone="green">{sub?.cancel_at_period_end ? "Active until period end" : "Active"}</Pill>
            ) : troubled ? (
              <Pill tone="red">Payment issue</Pill>
            ) : (
          ...
          {active ? (
            ...
            <>
              <p className="mt-5 text-sm text-ink-soft">
                Subscribe to run strategy projects: live web research, cited competitor and market analysis, three options, an editable
                recommendation, a business case and a 90-day plan. Billed monthly in {PLAN.currency}, no free trial, cancel anytime.
              </p>
              <div className="mt-6 flex flex-wrap gap-3">
